...
export const SCHEMA_FORM_RPCK_ITM: FormSchemaType = {
    ...
    schema: {
        ...
        blGwght: { type: "number", label: "L_BL_GWGHT", rightText: "KG" },
        gwghtUtCd: { type: "text", label: "L_GWGHT_UT_CD" },
        blNwght: { type: "text", label: "L_BL_NWGHT", rightText: "KG" },
        nwghtUtCd: { type: "text", label: "L_NWGHT_UT_CD" },
        blGvlm: { type: "text", label: "L_BL_GVLM" },
        vlmUtCd: { type: "text", label: "L_VLM_UT_CD" },
        loadPortCd: { type: "text", label: "L_LOAD_PORT_CD", required: true },
        dstnPlcCd: { type: "text", label: "L_DSTN_PLC_CD", required: true },
        ...
        pckgTpCd: { type: "select", label: "L_PCKG_TP_CD" },
